...
Real-time music visualization for Nothing Phone Glyphs, haptics, and flashlight, using **FFT audio analysis** for pixel-perfect frequency response, in addition to offering extensive customization.
...
### 🔊 Haptics & Flashlight
Any Android phone works for haptic and flashlight visualization modes.
...
- **[Python script (legacy)](https://github.com/oliver-lebaigue-bright-bench/glyph-syncronator/wiki/)** — Bulk audio file processing
- **[Issue tracker](https://github.com/oliver-lebaigue-bright-bench/glyph-syncronator/issues)** — Bugs? Feature requests?
...
- **[GitHub Discussions](https://github.com/oliver-lebaigue-bright-bench/glyph-syncronator/discussions)** — Feature ideas or bug reports 
...
- **Screen Capture**: Screen Capture is only used to process audio exposed by the Android Media Projection API. No video or screen content is stored or transmitted.
- **Audio**: Only analyzed in real-time RAM buffers for visualization—never saved or transmitted.
- **Analytics**: Optional, anonymous usage stats to help fix crashes and improve stability.
