package com.better.nothing.music.visualizer.widget
...
import com.better.nothing.music.visualizer.util.PermissionTrampolineActivity
...
class VisualizerWidget : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == "com.better.nothing.music.visualizer.REFRESH_WIDGET") {
